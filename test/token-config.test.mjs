...
import { DECIMALS, DEVNET_RPC, DISPLAYED_SUPPLY, RAW_SUPPLY, UI_MULTIPLIER } from '../token/create-scheiss.mjs';

test('Scheisscoin uses the specified Devnet-only supply configuration', () => {
